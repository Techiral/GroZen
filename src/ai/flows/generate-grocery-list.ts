...
const GenerateGroceryListOutputSchema = z.object({
  items: z.array(GroceryItemSchema).describe('An array of grocery items, categorized and with optional quantities and notes.'),
});
...
- For each item, provide its name, category, and optionally, quantity and notes.
...
Example item: { "name": "Brown Rice", "category": "Grains & Pantry", "quantity": "1 bag (2 lbs)" }
`,
});
